...
| R.S.13.3 | CF error → kliens info-disclosure (raw error message) | HIGH | Med | V7 | Codex review | 2026-05-15 | TBD | **Phase 1.0 partial close** (fail() centralized strip + main.js + 2 success ad-hoc; Phase 1.5: success-response audit; Phase 2: maradék CF) |
