...
- [/] **S.7.10** — Phase 3 code-only refactor (`tryEnsureMembershipNonBlocking` helper). LOW, NEM-blocker.
- [/] **S.7.11** — Phase 3 code-only refactor (`TEAM_SKIP_REASONS` stringly-typed enum). LOW, NEM-blocker.
