/**
 * AUTO-GENERATED CommonJS port a kanonikus `maestro-shared/piiRedaction.js`-ből
 * (S.13.2 Phase 2 wrap az update-article CF-en).
 *
 ...
 * (`packages/maestro-shared/piiRedaction.js`).
 */
